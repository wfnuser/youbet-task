        ...
        <div className="space-y-6 w-full lg:w-1/3">
          ...
          <Card className="space-y-1 shadow-lg p-4 rounded-lg">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between items-center">
                <p className="mb-2 font-bold text-gray-400 text-l">{totalRewards.toFixed(5)} ETH</p>
              </div>
            </div>
            <div className="space-y-1">
              <h3 className="font-semibold text-lg text-white">To Claim</h3>
              <div className="flex justify-between items-center">
                <p className="mb-2 font-bold text-gray-400 text-l">{(totalRewards - claimedRewards).toFixed(5)} ETH</p>
